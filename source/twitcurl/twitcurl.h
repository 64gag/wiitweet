...
namespace twitCurlDefaults
{
    ...
    const std::string TWITCURL_EXTENSIONFORMATS[3] = { ".xml",
                                                       ".json",
                                                       ".atom"
                                                     };
    ...
    const std::string TWITCURL_INREPLYTO = "in_reply_to_status_id=";
    const std::string TWITCURL_TRIMUSER = "trim_user=true";
    const std::string TWITCURL_INCRETWEETS = "include_rts=true";
    const std::string TWITCURL_INCENTITIES = "include_entities=true";
    const std::string TWITCURL_INCMYRETWEETS = "include_my_retweet=1";
    ...
    const std::string TWITCURL_COMMON_PARAMS = twitCurlDefaults::TWITCURL_INCENTITIES + twitCurlDefaults::TWITCURL_URL_SEP_AMP + twitCurlDefaults::TWITCURL_INCMYRETWEETS + twitCurlDefaults::TWITCURL_URL_SEP_AMP + twitCurlDefaults::TWITCURL_INCRETWEETS;
};
...
namespace twitterDefaults
{
    ...
    const std::string TWITCURL_SEARCHUSERS_URL = "api.twitter.com/1/users/search";
    const std::string TWITCURL_USERSLOOKUP_URL = "api.twitter.com/1/users/lookup";
    ...
    const std::string TWITCURL_FRIENDHISPEXISTS_URL =  "api.twitter.com/1/friendships/exists";
...
public:
    ...
    /* Twitter search APIs */
    bool search( std::string& searchQuery /* in */, std::string& max_id );
    bool usersSearch( std::string& searchQuery, std::string& page );
    
    /* Twitter status APIs */
    bool statusUpdate( std::string& newStatus, std::string * replyTo );
    ...
    bool timelineFriendsGet(std::string& max_id);
    bool timelineUserGet( bool trimUser /* in */, unsigned int tweetCount /* in */, std::string& max_id, std::string userInfo = "" /* in */, bool isUserId = false /* in */ );
    bool featuredUsersGet();
    bool mentionsGet( std::string &max_id /* in */ );
	...
	bool usersLookup( std::string& userInfo, bool isUserId);
    ...
    bool friendshipExists( std::string& user_id_a, std::string& user_id_b);
    ...
    bool favoriteGet( std::string& userInfo, bool isUserId , std::string& max_id );
    bool favoriteCreate( std::string& statusId /* in */ );
    bool favoriteDestroy( std::string& statusId /* in */ );
    bool retweet( std::string& statusId /* in */ );
...
private:
    ...
    bool performGet( const std::string& getUrl, int anon = 0);
